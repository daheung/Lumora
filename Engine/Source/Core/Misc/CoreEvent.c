 ...
 */
static bool8 bIsInitialized = FALSE;
...
bool8 InitializeEvent()
{
    ...
    HZeroMemory(&GEventSystemState, sizeof(FEventSystemState));
...
{
    LUMORA_LOG(bIsInitialized, LOG_LEVEL_FATAL, "CoreEvent has not been initialized.");
